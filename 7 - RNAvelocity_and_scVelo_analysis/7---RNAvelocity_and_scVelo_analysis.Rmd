...
<!-- ``` -->
<!-- IF no error happens, this will generate the "*name.sample*.ldat.filtered" file.  -->
...
```
![scVelo results for merged sample](./scvelo_scVelo_comp1_2_modified_linewith3.svg)
...
```
![scVelo results for merged sample](./scvelo_scVelo_comp1_3_modified_linewith3.svg)
