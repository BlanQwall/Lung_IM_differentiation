...
DoHeatmap(imdtr3.for3d, features = top20$gene, group.colors = pal, size = 0) + scale_fill_gradientn(colors = c("dark blue", "black", "red")) +
...
DotPlot(imdtr3.for3d, features = c("Ccr2", "Irf7", "Ly6c2",
                                   "Ace", "Nr4a1", "Fcgr4", 
                                   "H2-Ab1", "H2-Eb1", "Cd74", 
                                   "Lyve1", "Mrc1", "C1qa", 
                                   "Tnf", "Bax", "Trp53", 
...
```{r}
# color gradient
col_gradient <- colorRampPalette(c("dark blue", "red"))(256)
