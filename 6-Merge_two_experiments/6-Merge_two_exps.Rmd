...
DoHeatmap(imdtr3.for3d, features = top20$gene, group.colors = pal, size = 0) + scale_fill_gradientn(colors = c("lightgrey", "red")) +
   theme(axis.text.y = element_text(size = 4))
```

```{r include=FALSE}
ggsave(filename = "HeatMap_top20_in_cell_types.pdf",
       path = "../Figures", 
       height = 6, width = 5, 
       device = "pdf")
```
