...
```{r}
Heatmap(as.matrix(mat.scale), show_row_names = TRUE, show_column_names = FALSE, 
...
```{r}
ggsave(filename = "../Figures/Heatmap_IM_vs_Mafb-neo.pdf", height = 10, width = 8)
```

Show in vlnplot

```{r}
VlnPlot(neo_IM, features = c("Mafb", ""), group.by = "cell.type2")
```
