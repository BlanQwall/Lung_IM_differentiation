...
```{r}
geneSymbol.changed <- heatSmooth_combined.changed@ht_list$matrix_7@row_names_param$labels

geneSymbol.changed.mhcii <- geneSymbol.changed[heatSmooth_combined.changed@ht_list$matrix_7@row_order_list[[1]]]

geneSymbol.changed.cd206 <- geneSymbol.changed[heatSmooth_combined.changed@ht_list$matrix_7@row_order_list[[2]]]
```
...
write.csv(result.enrichKEGG@result, file = "./Results_enrichment/enrichKEGG_MHCII_IM_specific_genes.csv")
...
result.enrichKEGG <- enrichKEGG(de_entrez, organism = "mmu", keyType = "ncbi-geneid")
result.enrichKEGG <- replaceEntrezID(result.enrichKEGG, organism = "mmu")
write.csv(result.enrichKEGG@result, file = "./Results_enrichment/enrichKEGG_CD206_IM_specific_genes.csv")
result.enrichKEGG@result
```
