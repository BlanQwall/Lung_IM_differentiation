...
The raw scRNAseq data were mapped and counted in the analysis 2. Here we check the sample quality and build up Seurat object from the counts matrix using Seurat package [@SeuratV4]. 
