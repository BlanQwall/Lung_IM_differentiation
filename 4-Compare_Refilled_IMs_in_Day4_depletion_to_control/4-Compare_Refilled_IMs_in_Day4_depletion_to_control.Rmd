...
Data processing, cell clustering, linear- or non-linear dimension reduction were made in Seurat package [@SeuratV4] and the celltyping was made by SingleR pakcage [@SingleR]. Cells were firstly clustered with high resolution in order that the contaminated cells would be clustered together and identified with SingleR package. Once the contaminated cells removed, data of the filtered cells were then re-filtered and clustered for further analyses. 
